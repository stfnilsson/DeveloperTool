...
namespace UWPDevTools.UI
{
    internal class XamlGridRenderer : IDisposable
    {
        ...
        private List<SpriteVisual> DrawGrid(XamlGridLine gridLine, float controlWidth, float controlHeight)
        {
            ...
            {
                visuals.Add(CreateHorizontalLine(controlWidth, currentYOffet, gridLine.GridColor, gridLine.GridSize));
            ...
            {
                visuals.Add(CreateVerticalLine(controlHeight, currentXOffet, gridLine.GridColor, gridLine.GridSize));
